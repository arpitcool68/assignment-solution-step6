...
public class LoggerAspect {
	...
	@AfterReturning(value = "execution(* com.stackroute.newz.controller.NewsController.*.*(..))", returning = "result")
	...
	@AfterThrowing(value = "execution(* com.stackroute.newz.controller.NewsController.*.*(..))")
